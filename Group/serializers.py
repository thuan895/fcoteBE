...
class CreateGroupSerializer(serializers.Serializer):
    title = serializers.CharField(required=True, max_length=255, allow_blank=True)
    description = serializers.CharField(required=True, max_length=10000, allow_blank=True)
    image = serializers.CharField(required=False, max_length=255, allow_blank=True)
...
class JoinGroupSerializer(serializers.Serializer):
    joinCode = serializers.CharField(required=True, max_length=255, allow_blank=True)
